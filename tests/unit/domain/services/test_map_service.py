...
def test_map_service_init():
    ...
    map_service = MapService(stop_repository=stop_repository, route_repository=route_repository, shape_repository=shape_repository, trip_repository=trip_repository)
