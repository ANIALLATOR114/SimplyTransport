...
class AppSettings(BaseSettings):
    ...
    VERSION: str = "0.10.0"  # Version bumping will cache bust static css/js files
    ...
    DB_ECHO: bool = False
    TIMESCALE_URL: str = "postgresql+asyncpg://user:password@localhost:5433/st_ts_database"
